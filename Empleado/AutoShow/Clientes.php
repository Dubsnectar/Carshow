...
<body class="wide comments example">
  ...
  while($row = mysqli_fetch_array($consulta))
  {
    ...
    echo "<td>" . 
	    $row["ApellidoP_Cliente"] . "</td>";
		
    echo "<td>" . 
	    $row["ApellidoM_Cliente"] . "</td>";
	...
	echo "<td>" . 
	    $row["Direccion_Cliente"] . "</td>";
	
	echo "<td>" . 
	    $row["Colonia_Cliente"] . "</td>";
	
	echo "<td>" . 
	    $row["Estado_Cliente"] . "</td>";
		
	echo "<td>" . 
	    $row["Pais_Cliente"] . "</td>";
		
	echo "<td>" . 
	    $row["Telefono_Cliente"] . "</td>";
		
	echo "<td>" . 
	    $row["Correo_Cliente"] . "</td>";
