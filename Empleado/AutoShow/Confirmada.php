...
$Nombre_Vendedor = $_REQUEST['Nombre_Vendedor'];
 $Matricula_Vendedor = $_REQUEST['Matricula_Vendedor'];
...
VALUES ('$Precio_Total', '$Nombre_Vendedor', '$Nombre_Cliente','$Nombre_Auto','$Marca_Auto','$Tipo_Auto','$Precio_Auto','$Color_Auto','$Equipamento_Auto','$Precio_Equipamento','$Matricula_Vendedor','$ApellidoP_Cliente','$ApellidoM_Cliente','$Edad_Cliente','$Sexo_Cliente','$Direccion_Cliente','$Colonia_Cliente','$Estado_Cliente','$Pais_Cliente','$Telefono_Ciente','$Correo_Cliente')";
