...
<div class="form-group"> <!-- Full Name -->
        ...
        <input type="text" class="form-control" id="full_name_id" readonly name="Nombre_Vendedor" value="Miguel Angel">
    </div> 
<div class="form-group"> <!-- Full Name -->
        <label for="full_name_id" class="control-label">Matricula Vendedor</label>
        <input type="text" class="form-control" id="full_name_id" readonly name="Matricula_Vendedor" value="201321054">
    </div> 
